...
def SGD_sequence_lookup(g, d, l, m):
    ...
    if d == "none":
        ...
        m = "Query without flanking regions succesful"
        ...
        if l == "0.5kb" or l == "1.0kb" or l == "2.0kb":
            ...
            m = "Query with flanking regions succesful"
        else:
...
for i in range(0, max_row):
    ...
    if message == "Query without flanking regions succesful" or message == "Query with flanking regions succesful":
        for x in data:
            ws.append(x)
    else:
